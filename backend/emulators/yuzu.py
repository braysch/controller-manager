    ...
    def _get_controller_mappings(
        ...
        if is_xbox:
            ...
            return {
                ...
                "button_x": f"button:3,guid:{guid},port:{port},engine:sdl",
                "button_y": f"button:2,guid:{guid},port:{port},engine:sdl",
                "button_lstick": f"button:13,guid:{guid},port:{port},engine:sdl",
                "button_rstick": f"button:14,guid:{guid},port:{port},engine:sdl",
                "button_l": f"button:4,guid:{guid},port:{port},engine:sdl",
                "button_r": f"button:5,guid:{guid},port:{port},engine:sdl",
                "button_zl": f"threshold:0.5,axis:2,guid:{guid},port:{port},engine:sdl",
                "button_zr": f"threshold:0.5,axis:5,guid:{guid},port:{port},engine:sdl",
                "button_plus": f"button:7,guid:{guid},port:{port},engine:sdl",
                "button_minus": f"button:6,guid:{guid},port:{port},engine:sdl",
                ...
                "button_home": f"button:8,guid:{guid},port:{port},engine:sdl",
                ...
                "rstick": f"invert_y:+,invert_x:+,offset_y:0.000000,axis_y:4,offset_x:-0.000000,axis_x:3,guid:{guid},port:{port},engine:sdl",
                "motionleft": "[empty]",
                "motionright": "[empty]",
            }
        else:
